...
ActiveRecord::Schema.define(version: 2022_04_09_133841) do
  ...
  create_table "ticket_payments", id: :integer, unsigned: true, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "tickets", id: :integer, unsigned: true, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.text "name"
  ...
  create_table "trip_ticket_packs", id: :integer, unsigned: true, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.text "name"
    t.bigint "trip_id", null: false, unsigned: true
